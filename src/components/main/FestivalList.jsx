    ...
    <div>
      <Swiper slidesPerView={1.3} spaceBetween={12} className="mySwiper">
        {festivities.map(item => (
          <SwiperSlide
            key={item.strfId}
            className="aspect-[3/4] cursor-pointer relative text-white rounded-tl-[32px] rounded-br-[32px] overflow-hidden after:absolute after:left-0 after:bottom-0 after:w-full after:h-[50%] after:bg-gradient-to-b after:from-transparent after:to-black after:opacity-70"
