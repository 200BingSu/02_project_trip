  ...
  return (
    <>
      ...
      <section className="flex flex-col gap-5 items-center mb-10">
        <h2 className="w-full text-lg font-semibold text-slate-700">관광지</h2>
      ...
      {/* 숙소 */}
      <section className="flex flex-col gap-5 items-center mb-10">
        <h2 className="w-full text-lg font-semibold text-slate-700">숙소</h2>
        <ul className="w-full flex flex-col gap-5">
      ...
      {/* 맛집 */}
      <section className="flex flex-col gap-5 items-center mb-10">
        <h2 className="w-full text-lg font-semibold text-slate-700">맛집</h2>
        <ul className="w-full flex flex-col gap-5">
      ...
      {/* 축제 */}
      <section className="flex flex-col gap-5 items-center mb-10">
        <h2 className="w-full text-lg font-semibold text-slate-700">축제</h2>
        <ul className="w-full flex flex-col gap-5">
